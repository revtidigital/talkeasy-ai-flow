...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We deploy in your cloud (AWS/Azure/GCP/VPC) where required. We're GDPR- and CCPA-compliant, and engineer each solution to meet the specific compliance requirements of your engagement (e.g. DPDP India). No training on your data.",
  },
  {
